        ...
        <div className="mt-16 bg-neutral-50 rounded-2xl p-8 md:p-12">
          <div className="max-w-3xl">
            ...
            <p className="text-neutral-700 leading-relaxed text-lg">
              AHHD is an informational directory. Listings are based on accreditation data from ACHC (Accreditation Commission for Health Care). We don't endorse specific providers, so always verify details and conduct your own research when choosing a care provider.
            </p>
          </div>
        </div>
      </div>
