      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12">
          ...
          <div className="text-center">
            ...
            <p className="text-neutral-700 leading-relaxed">
              Review provider details and contact them directly. We surface accreditation status — we don't endorse specific providers.
            </p>
          </div>
        </div>
        ...
        <div className="mt-16 bg-neutral-50 rounded-2xl p-8 md:p-12">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-neutral-700 leading-relaxed text-lg">
              AHHD is an informational directory. Listings are based on accreditation data from ACHC (Accreditation Commission for Health Care). We don't endorse specific providers — always verify details and conduct your own research when choosing a care provider.
            </p>
          </div>
        </div>
      </div>
